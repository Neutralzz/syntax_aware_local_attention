...
from models import TokenClsModel, SentClsModel
import task_utils
import pickle, time
...
def evaluate(args, model, tokenizer, batch_processor, prefix=""):
    ...
    results = task_utils.evaluate(args.task, eval_data)
...
if __name__=='__main__':
    ...
    parser.add_argument("--data_dir", default="/data/dobby_ceph_ir/neutrali/workspace/VenusData/SynBert", type=str,
    ...
    parser.add_argument("--num_save_ckpts", default=2, type=int)
